...
מיפה בזאת את כוחו של עו"ד {{lawyerName}}, ברקוביץ 4, מגדל המוזיאון, תל אביב, טלפון: 03-6951408,
...
3. א. התשלום. בעבור השירותים המשפטיים שלעיל, ישלם הלקוח: {{totalPrice}} ש"ח
לחשבון 1846260, בנק לאומי 988. (להלן: "שכ"ט").
...
7. שכר הטרחה אינו כולל אגרות, שליחויות והוצאות נלוות ככל שיהיו.
