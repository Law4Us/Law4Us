...
/**
 * Fee Agreement (הסכם שכר טרחה) - displayed as summary for user acknowledgment
 * Full legal agreement is sent separately
 */
export const FEE_AGREEMENT_SUMMARY = {
  title: 'תנאי השירות והסכם שכר טרחה',
  sections: [
    {
      title: 'היקף השירות',
      content: `השירות כולל הכנת כתבי תביעה ומסמכים משפטיים בהתאם לסוג התביעה/ות שנבחרו. המסמכים יוכנו על ידי משרד עו"ד אריאל דרור ויישלחו ללקוח לעיון.`,
    },
    {
      title: 'מה לא כלול בשירות',
      content: `השירות אינו כולל: ייצוג בבית המשפט, הגשת המסמכים לבית המשפט, ייעוץ משפטי טלפוני או פגישות מעבר לאמור, או כל שירות שלא פורט במפורש.`,
    },
    {
      title: 'שכר הטרחה',
      content: `שכר הטרחה הינו בהתאם למחיר ששולם באתר. התשלום הינו עבור הכנת המסמכים בלבד.`,
    },
    {
      title: 'אחריות הלקוח',
      content: `הלקוח אחראי לספק מידע מלא ומדויק. המשרד אינו אחראי לטעויות הנובעות ממידע שגוי או חלקי שסופק על ידי הלקוח.`,
    },
    {
      title: 'ביטולים והחזרים',
      content: `ניתן לבטל את ההזמנה בתוך 14 יום מיום הרכישה, בכפוף לחוק הגנת הצרכן. לאחר הפקת המסמכים, לא יינתן החזר כספי.`,
    },
  ],
  acknowledgmentText: 'קראתי והבנתי את תנאי השירות והסכם שכר הטרחה ואני מסכים/ה להם.',
};
