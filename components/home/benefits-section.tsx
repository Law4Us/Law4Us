    ...
    <section className="py-12 md:py-16 lg:py-20">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <SlideInView delay={0} direction="up" duration={600} threshold={0.2}>
          ...
          <SlideInView delay={100} direction="up" duration={600} threshold={0.2}>
            <div style={CARD_STYLES.container}>
              <div style={CARD_STYLES.iconCircle}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <SlideInView delay={200} direction="up" duration={600} threshold={0.2}>
            <div style={CARD_STYLES.container}>
              <div style={CARD_STYLES.iconCircle}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <SlideInView delay={300} direction="up" duration={600} threshold={0.2}>
            <div style={CARD_STYLES.container}>
              <div style={CARD_STYLES.iconCircle}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
