...
export const metadata: Metadata = {
  ...
  description:
    "מדריך מקיף להליך הגירושין בישראל: מזונות, משמורת, חלוקת רכוש והדרך כולה עד לקבלת פסק הדין. כל המידע שצריך לדעת לפני התחלת ההליך. תיאום פגישת ייעוץ חינם.",
  keywords: [
    "הליך גירושין בישראל",
    "מדריך גירושין",
    "איך להתגרש",
  ...
  openGraph: {
    title: "מדריך גירושין מקיף | Law4Us - כל מה שצריך לדעת",
    description: "מדריך שלב אחר שלב להליך הגירושין: מזונות, משמורת, חלוקת רכוש ועוד.",
    url: "https://law-4-us.co.il/divorce",
    images: ["/og-image.png"],
  },
  alternates: {
    canonical: "https://law-4-us.co.il/divorce",
  },
};
