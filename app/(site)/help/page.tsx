...
const helpFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "מחיר השירות הוא 3,900 ₪ לכל הליך. מע״מ מחושב על מחיר השירות בלבד, ואגרת בית משפט או אגרה ממשלתית מתווספת בנפרד לפי סוג ההליך ללא מע״מ. הפירוט המלא מוצג לפני התשלום.",
  },
  {
